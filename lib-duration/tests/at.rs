...
mod with_part {
    ...
    fn at_0am() {
        let input = "at 0am";
        let now = Utc.ymd(2020, 9, 30).and_hms(23, 45, 0);
    ...
    fn at_1am() {
        let input = "at 1am";
        let now = Utc.ymd(2020, 9, 1).and_hms(0, 20, 0);
    ...
    fn at_12pm() {
        let input = "at 12pm";
        let now = Utc.ymd(2020, 9, 1).and_hms(5, 45, 0);
    ...
    fn at_0pm() {
        let input = "at 0pm";
        let now = Utc.ymd(2020, 9, 30).and_hms(9, 50, 0);
